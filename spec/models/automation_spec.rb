...
RSpec.describe Automation, type: :model do
  ...
  describe 'repository' do
    ...
    it 'should not allow passwords in the url' do
      expect(FactoryGirl.build(:chef, repository: 'https://user:pass@github.com/blafasel.git')).not_to be_valid
      expect(FactoryGirl.build(:chef, repository: 'https://user@github.com/blafasel.git')).to be_valid
    end
