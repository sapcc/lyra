...
RSpec.describe 'Test Automations API' do
  describe 'Get all automations' do
    ...
    context 'automation_admin' do
      ...
      it 'displays repository_credentials_enabled if repository_credentials is set' do
        get '/api/v1/automations', headers: { 'X-Auth-Token' => token_value }
        expect(response).to be_successful
        json = JSON.parse(response.body)
        ...
        expect(json[0]['repository_credentials_enabled']).to eq(true)
        expect(json[1]['repository_credentials']).to eq(nil)
        expect(json[1]['repository_credentials_enabled']).to eq(true)
      end
    end
    ...
    context 'automation_admin' do
      ...
      context 'Script' do
        ...
        it 'displays repository_credentials_enabled if repository_credentials is set' do
          ...
          expect(json['repository_credentials_enabled']).to eq(true)
        end
        ...
        it 'returns blank if repository_credentials is NOT set' do
          ...
          expect(response).to be_successful
          expect(json['repository_credentials']).to eq(nil)
          expect(json['repository_credentials_enabled']).to eq(false)
        end
      end
  ...
  describe 'create an automation' do
    describe 'script' do
      context 'automation_admin' do
        ...
        it 'creates an automation with default false repository_credentials_enabled' do
  ...
  describe 'update an automation' do
    describe 'Chef' do
      ...
      context 'automation_admin' do
        ...
        it 'set repository_credentials_enabled flag to false if repository_credentials removed' do
          ...
          expect(chef.repository_credentials_enabled).to eq(false)
        end
